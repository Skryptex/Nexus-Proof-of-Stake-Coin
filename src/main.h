...
static const unsigned int PROTOCOL_SWITCH_TIME = 1423909632; //GMT: Sat, 14 Feb 2015 10:27:12 GMT

static const unsigned int REWARD_SWITCH_TIME = 1422772760; //GMT: Sun, 01 Feb 2015 06:39:20 GMT
...
public:
    ...
    {
        // nexus: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // nexus: get transaction coin age
...
public:
    ...
    // nexus: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // nexus: entropy bit for stake modifier if chosen by modifier
    ...
    // nexus: two types of block: proof-of-work or proof-of-stake
    ...
    // nexus: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // nexus: calculate total coin age spent in block
